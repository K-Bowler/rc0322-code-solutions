...
console.log('ISB of Introduction to JavaScript Object Notation: A To-the-Point Guide to JSON:', bookshelf[0].isbn);
console.log('Title of an API book by Phil Sturgeon & Laura Bohill:', bookshelf[2].title);
